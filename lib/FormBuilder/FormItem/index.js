...
var findBuiltInRules = function findBuiltInRules(rules) {
  ...
  rules.forEach(function(rule) {
    _builtInRules2.default.find(function(_ref, index) {
      var builtInType = _ref.builtInType;

      if (rule[builtInType]) {
        newRulesToState.push(_builtInRules2.default[index].get(rule));
        return true;
      }
      return false;
    });
...
var FormItem = (function(_React$PureComponent) {
  ...
  function FormItem() {
    ...
    return (
      ...
      (_this.validatorCallback = function(params) {
        Promise.resolve().then(function() {
          return _this.props.onChangeError(params);
        });
      }),
          ...
          var _props = this.props,
            ...
            children =
              _props$children === undefined
                ? function(i) {
                    return (
                      console.error('children must be a function', i) || null
                    );
                  }
                : _props$children,
        ...
        value: function getDerivedStateFromProps(nextProps, prevState) {
          if (nextProps.rules !== prevState.mirroredRules) {
            return {
              ...
              required: nextProps.rules.find(function(_ref3) {
