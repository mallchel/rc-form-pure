...
var _initialiseProps = function _initialiseProps() {
  ...
  this.setFieldValue = function(args) {
    // save current isFieldsTouched
    _this2.onChange(
      _extends({}, args, { isFieldsTouched: _this2.state.isFieldsTouched })
    );
  };
  ...
  this.onSubmit = function(event) {
    ...
    var _state2 = _this2.state,
      _state2$errors = _state2.errors,
      errors = _state2$errors === undefined ? {} : _state2$errors,
