...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onCheckError = function(_ref3) {
    ...
    if (!error) {
      var deletingError = errors[type],
        restErrors = _objectWithoutProperties(errors, [type]);
  ...
  this.saveRefValidateItem = function(_ref5) {
    var type = _ref5.type,
      onValidateItem = _ref5.onValidateItem;
  ...
  this.renderLayout = function(restConfigs, layout) {
    ...
    var contentInLayout = layout.map(function(_ref6, index) {
      var _ref6$container = _ref6.container,
        Container =
          _ref6$container === undefined
            ? function(_ref7) {
