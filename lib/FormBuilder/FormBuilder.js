...
var _initialiseProps = function _initialiseProps() {
  ...
  this.setFieldValue = function(_ref4) {
    var type = _ref4.type,
      value = _ref4.value;
  ...
  this.mapperConfig = function(key, config, values, initialValues, errors) {
    var value = values[key] || initialValues[key]; // to maintain control over the component
