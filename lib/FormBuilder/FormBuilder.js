  ...
  _createClass(FormBuilder, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          renderForm = _props$renderForm === undefined ? withForm ? _Form2.default : function (_ref2) {
      ...
      var content = this.renderLayout(fieldsConfig, layout, this.state.stateValues, this.state.errors);
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onChange = function (_ref3) {
    var type = _ref3.type,
        _ref3$value = _ref3.value,
        value = _ref3$value === undefined ? _this2.state.stateValues[type] : _ref3$value,
        error = _ref3.error;
    ...
    if (!error) {
      ...
      newErrors = _extends({}, _this2.state.errors, _defineProperty({}, type, error));
    }

    _this2.setState({
      stateValues: _extends({}, _this2.state.stateValues, _defineProperty({}, type, value)),
      errors: newErrors,
  ...
  this.onSubmit = function (event) {
    ...
    _this2.props.onSubmit({
      ...
      errors: Object.keys(_this2.state.errors).length === 0 ? null : _this2.state.errors
    });
  };
  ...
  this.renderLayout = function (restConfigs, layout) {
    ...
    var contentInLayout = layout.map(function (_ref4, index) {
      var _ref4$container = _ref4.container,
          Container = _ref4$container === undefined ? function (_ref5) {
      ...
      return _react2.default.createElement(Container, {
        ...
        children: items.map(function (key) {
          ...
          return _this2.mapperConfig.apply(_this2, [key, currentConfig].concat(args));
        })
      });
    });
    ...
    if (itemsWithoutLayout.length) {
      otherContent = itemsWithoutLayout.map(function (key) {
        return _this2.mapperConfig.apply(_this2, [key, _restConfigs[key]].concat(args));
      });
    }
